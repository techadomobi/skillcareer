      ...
      <footer className="bg-slate-900 text-white py-12">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">SkillCareer</h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                <li><a href="/web-development-course" className="hover:text-white transition-colors">Web Development</a></li>
                <li><a href="/digital-marketing-course" className="hover:text-white transition-colors">Digital Marketing</a></li>
                <li><a href="/data-analytics-course" className="hover:text-white transition-colors">Data Analytics</a></li>
                <li><a href="/ui-design-course" className="hover:text-white transition-colors">UI/UX Design</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-md font-semibold mb-4">Contact</h4>
              <div className="text-slate-400 space-y-2">
                <p>📧 info@skillcareer.in</p>
                <p>📞 +91 98765 43210</p>
                <p>📍 Delhi, India</p>
              </div>
            </div>
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center text-slate-400 text-sm">
            <p>&copy; {new Date().getFullYear()} SkillCareer. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
