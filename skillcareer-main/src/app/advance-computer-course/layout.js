// app/advanced-computer-course/layout.js
import React from 'react';
import { buildCourseMetadata } from "@/lib/course-seo";

// SEO Metadata for the /advanced-computer-course route and its children
...
export default function AdvancedComputerCourseLayout({ children }) {
  return (
    <>
      {/* You could add a specific sub-navigation or header here if needed */}
      {/* e.g., <AdvancedComputerCourseHeader /> */}
